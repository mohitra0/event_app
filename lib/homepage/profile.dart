              ...
              ListView(
                children: <Widget>[
                  Stack(
                    children: <Widget>[
                      Container(
                        height: constraints.maxWidth >= 720 ? MediaQuery.of(context).size.height / 2 : MediaQuery.of(context).size.height / 2.25,
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: FloatingActionButton.extended(
                                    ...
                                    backgroundColor: Color(0xff18d26e).withOpacity(0.8),
                                  ),
                                ),
                              ],
                            )),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        StreamBuilder(
                            stream: Firestore.instance.collection('saved').document(uid).collection('savedItems').snapshots(),
